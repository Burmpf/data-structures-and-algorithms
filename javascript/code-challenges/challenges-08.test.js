...
Write a function named isCapitalized that takes in a string. This function should use a regular expression pattern to match all test that begin with a capital letter. It should only match test, not punctuation.
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  return arr.filter(otherWords => {
    return /^[A-J]/g.test(otherWords);
  });
};
...
Write a function named noPunctuation that contains a regular expression pattern to find all of the test that contain a space immediately at the end of the word. Return an array of all such test, still containing the space at the end.
...
Write a function named findShells that takes in the string below and uses a regular expression pattern to find all instances of the following test: "sells", "shells", "seashells".

Do not use the vertical bar (pipe) character.

Hint: All of these test end with the letters "ells".
------------------------------------------------------------------------------------------------ */
...
describe('Testing challenge 5', () => {
  test('It should only return test that begin with a capital letter', () => {
    const capitalResult = isCapitalized('We only want to Return the test that begin With a capital Letter');

    expect(capitalResult).toStrictEqual(['We', 'Return', 'test', 'With', 'Letter']);
    ...
    expect(isCapitalized('these test are all failures')).toStrictEqual([]);
  });
});
...
xdescribe('Testing challenge 8', () => {
  ...
  test('It should only return test that are immediately followed by a space', () => {
  ...
  test('It should not contain test that are followed by any non-space character', () => {
